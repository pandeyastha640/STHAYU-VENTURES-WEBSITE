...
function SocialLink({ href, label, children }) {
  return (
    <a href={href} target="_blank" rel="noreferrer" aria-label={label} className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-[12px] font-semibold text-slate-300 transition-all duration-300 hover:border-[#d4b982]/30 hover:bg-white/[0.04] hover:text-[#d4b982]">
      {children}
    </a>
  )
}
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#030303] px-5 pb-8 pt-20 sm:px-6 md:px-8 md:pt-28">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="interactive-tilt relative overflow-hidden rounded-[30px] border border-[#d4b982]/20 bg-white/[0.02] p-7 md:p-10 lg:p-12">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_50%,rgba(212,185,130,0.06),transparent_40%)]" />
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="text-[10px] uppercase tracking-[0.18em] text-[#d4b982]">Get in touch</p>
            ...
            <a href="mailto:hello@sthayuventures.com?subject=Discovery%20Call%20with%20Sthayu" className="inline-flex items-center justify-center gap-3 rounded-full border border-[#d4b982]/30 bg-[#d4b982]/[0.05] px-6 py-3.5 text-[11px] font-medium uppercase tracking-[0.16em] text-[#d4b982] transition-all duration-300 hover:border-[#d4b982]/60 hover:bg-[#d4b982]/10">
        ...
        <div className="grid gap-12 py-16 md:grid-cols-[1.4fr_0.8fr_0.8fr_0.8fr] md:py-20">
          <div className="max-w-sm">
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href="mailto:hello@sthayuventures.com" aria-label="Email Sthayu" className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-slate-300 transition-colors hover:border-[#d4b982]/30 hover:bg-white/[0.04] hover:text-[#d4b982]">
                <Mail size={14} />
              </a>
          ...
          <div>
            ...
            <div className="mt-6 space-y-3.5">
              {serviceLinks.map((item) => (
                <button key={item} type="button" onClick={() => scrollTo("services")} className="block text-left text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">{item}</button>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-3.5">
              {companyLinks.map((item) => (
                <button key={item.label} type="button" onClick={() => scrollTo(item.id)} className="block text-left text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">{item.label}</button>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-6 space-y-3.5">
              <button type="button" onClick={() => scrollTo("contact")} className="block text-left text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">Contact Us</button>
              <a href="mailto:hello@sthayuventures.com?subject=Discovery%20Call%20with%20Sthayu" className="block text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">Book a Free Call</a>
              <button type="button" className="block text-left text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">Privacy</button>
              <button type="button" className="block text-left text-[13px] text-slate-300 transition-colors hover:text-[#d4b982]">Terms</button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 border-t border-white/10 py-6 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#d4b982]/[0.08]"><Mail size={13} className="text-[#d4b982]" /></div>
            <div>
              <p className="text-[10px] uppercase tracking-[0.18em] text-slate-400">Get in touch</p>
              <a href="mailto:hello@sthayuventures.com" className="mt-1 block text-[14px] text-slate-300 transition-colors hover:text-[#d4b982]">hello@sthayuventures.com</a>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-5 pt-7 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-5 text-[10px] uppercase tracking-[0.15em] text-slate-500">
            ...
            <button type="button" onClick={() => scrollTo("hero")} className="group inline-flex items-center gap-2 transition-colors hover:text-[#d4b982]">
              Back to top
